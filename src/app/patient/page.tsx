      ...
      <main className="flex-1 md:ml-72 p-8 md:p-16 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            ...
            <div className="space-y-12 relative before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[1px] before:bg-outline-variant/30">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="aspect-square relative rounded-[32px] overflow-hidden border border-outline-variant group">
              ...
              <div className="space-y-4">
                ...
                <div className="aspect-square relative rounded-[32px] overflow-hidden border-2 border-primary group">
